...
# sss = create_db(init=True)
# ll = sss.Execute("SELECT * from Class;")
# #[print(l) for l in ll]
# with open("files/init_db.txt", 'r') as file:
#     qs = file.read().split(sep=';')
#     [sss.Execute(q) for q in qs]
